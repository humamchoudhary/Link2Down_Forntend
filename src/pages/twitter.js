...
export default function Twitter() {
  return (
    <>
      ...
      <Layout>
        <div className="border-tw border-2 rounded-md px-4 py-16 flex flex-col justify-center items-center gap-8">
          <h1 className="font-bold font-sans text-center">
            Download Video from twitter
          </h1>
          <div className="flex flex-row gap-2 border-2 border-tw rounded-md">
            <input
              className="bg-transparent w-4/5 focus:outline-none focus:text-tw active:outline-none px-4"
              placeholder="Paste your link here"
            />
            <div className="bg-tw  px-5 text-bg font-medium py-4 ">
              Download
            </div>
          </div>
        </div>
        <div className="mt-8 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-10 mb-12">
            <div className="w-full sm:w-1/2 md:w-1/4 mb-4 px-1 py-4 border-2 border-tw rounded-lg">
            ...
            <div className="w-full sm:w-1/2 md:w-1/4 mb-4 px-1 py-6 border-2 border-tw rounded-lg">
