...
import { BiSolidVideos, BiVolumeMute } from "react-icons/bi";
...
export default function Youtube() {
  ...
  function download_video(key) {
    ...
    axios
      ...
      .then((response) => {
        download(response.data, "video.mp4", "video/mp4");
        setLoadingData(false);
      })
      .catch((error) => {
        console.error("Error occurred during download:", error);
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10">
              ...
              <div className="">
                <table className="border-yt p-0 border-2 rounded-md flex flex-col gap-2 duration-300 transition-all">
                  <thead>
                    <tr className="border-0 bg-yt p-0">
                      <th cla>
                        <button
                          onClick={() => setContent("Video")}
                          className={` px-12 py-4 border-collapse border-0  ${
                            content === "Video"
                              ? "bg-bg text-yt"
                              : "bg-yt text-bg"
                          }`}
                  ...
                  <tbody>
                    <tr className="flex flex-col px-4">
                      <td colSpan="3">
                        ...
                        {content === "Video-Only" && (
                          <div>
                            {details.vid_res.map((key, index) => {
                              return (
                                <div
                                  className={`flex flex-row py-2 justify-between ${
                                    index !== details.vid_res.length - 1
                                      ? "border-b-2 "
                                      : ""
                                  }`}
                                >
